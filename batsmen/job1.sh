...
time hadoop jar IPL.jar /Assignment3/input_files_1 /Assignment3/output_of_batsmen_job_1 /Assignment3/output_of_batsmen_job_1/part-00000 /Assignment3/output_of_batsmen_job_2;
